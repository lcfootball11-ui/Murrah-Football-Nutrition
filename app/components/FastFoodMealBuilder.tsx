...
export const BRENTS_MENU: FFCategory[] = [
  {
    emoji: '🍔', label: 'Burgers & Hot Dog',
    items: [
      { name: "Brent's Burger (Single)",           macros: { cal: 550, protein: 32, carbs: 36, fat: 30 } },
      { name: "Brent's Burger (Double)",           macros: { cal: 800, protein: 52, carbs: 37, fat: 52 } },
      { name: 'Junior Burger',                     macros: { cal: 450, protein: 24, carbs: 34, fat: 24 } },
      { name: 'Patty Melt (Single)',               macros: { cal: 600, protein: 34, carbs: 38, fat: 34 } },
      { name: 'Patty Melt (Double)',               macros: { cal: 850, protein: 54, carbs: 39, fat: 55 } },
      { name: 'Veggie Burger',                     macros: { cal: 450, protein: 16, carbs: 58, fat: 18 } },
      { name: "Nathan's Hot Dog",                  macros: { cal: 350, protein: 12, carbs: 28, fat: 20 } },
    ],
  },
  {
    emoji: '🥪', label: 'Sandwiches',
    items: [
      { name: 'Club Sandwich',                     macros: { cal: 620, protein: 38, carbs: 46, fat: 30 } },
      { name: 'Chicken Sandwich (Grilled)',        macros: { cal: 500, protein: 38, carbs: 40, fat: 18 } },
      { name: 'Chicken Sandwich (Fried)',          macros: { cal: 620, protein: 36, carbs: 54, fat: 28 } },
      { name: 'Philly Cheesesteak',               macros: { cal: 650, protein: 40, carbs: 44, fat: 34 } },
      { name: 'Tuna Melt',                         macros: { cal: 520, protein: 26, carbs: 36, fat: 28 } },
      { name: 'BLT',                               macros: { cal: 450, protein: 16, carbs: 36, fat: 26 } },
      { name: 'Grilled Cheese',                    macros: { cal: 400, protein: 16, carbs: 38, fat: 22 } },
    ],
  },
  {
    emoji: '🥗', label: 'Salads & Soups',
    items: [
      { name: 'Cobb Salad',                        macros: { cal: 520, protein: 38, carbs: 14, fat: 36 } },
      { name: 'Chicken Salad (per scoop)',         macros: { cal: 220, protein: 14, carbs: 4,  fat: 18 } },
      { name: 'Tuna Salad (per scoop)',            macros: { cal: 200, protein: 14, carbs: 2,  fat: 16 } },
      { name: 'Pimento Cheese (per scoop)',        macros: { cal: 220, protein: 8,  carbs: 4,  fat: 20 } },
      { name: 'Egg & Olive Salad (per scoop)',     macros: { cal: 200, protein: 8,  carbs: 4,  fat: 18 } },
      { name: 'Salad Sampler (3 scoops)',          macros: { cal: 650, protein: 36, carbs: 14, fat: 54 } },
      { name: 'Chicken Salad Sandwich',            macros: { cal: 500, protein: 20, carbs: 44, fat: 28 } },
      { name: 'Tuna Salad Sandwich',               macros: { cal: 460, protein: 22, carbs: 42, fat: 24 } },
      { name: 'Pimento Cheese Sandwich',           macros: { cal: 500, protein: 14, carbs: 44, fat: 30 } },
      { name: 'Egg & Olive Sandwich',              macros: { cal: 480, protein: 14, carbs: 44, fat: 28 } },
      { name: 'Cheese Soup - Cup',                 macros: { cal: 250, protein: 10, carbs: 18, fat: 16 } },
      { name: 'Cheese Soup - Bowl',                macros: { cal: 420, protein: 18, carbs: 30, fat: 26 } },
      { name: 'Chili - Cup',                       macros: { cal: 250, protein: 16, carbs: 22, fat: 10 } },
      { name: 'Chili - Bowl',                      macros: { cal: 420, protein: 26, carbs: 36, fat: 16 } },
    ],
  },
  {
    emoji: '🍳', label: 'Breakfast',
    items: [
      { name: 'Fried Chicken Biscuit',             macros: { cal: 480, protein: 22, carbs: 46, fat: 24 } },
      { name: 'Sausage Biscuit',                   macros: { cal: 420, protein: 16, carbs: 38, fat: 24 } },
      { name: 'Fried Egg & Cheese Biscuit',        macros: { cal: 380, protein: 14, carbs: 36, fat: 20 } },
      { name: 'Eggs Your Way (2 eggs + meat)',      macros: { cal: 450, protein: 26, carbs: 28, fat: 28 } },
      { name: "Billy's Breakfast Burrito",         macros: { cal: 580, protein: 26, carbs: 44, fat: 34 } },
      { name: 'Omelet Your Way',                   macros: { cal: 400, protein: 28, carbs: 6,  fat: 28 } },
      { name: 'Buttermilk Pancakes (w/ bacon or sausage)', macros: { cal: 520, protein: 18, carbs: 64, fat: 20 } },
      { name: 'The Breakfast Melt',                macros: { cal: 480, protein: 22, carbs: 32, fat: 28 } },
      { name: 'Granola Parfait',                   macros: { cal: 350, protein: 14, carbs: 56, fat: 8  } },
    ],
  },
  {
    emoji: '🍟', label: 'Sides',
    items: [
      { name: 'House-Cut Fries',                   macros: { cal: 380, protein: 5,  carbs: 50, fat: 16 } },
      { name: 'Onion Rings',                       macros: { cal: 350, protein: 4,  carbs: 44, fat: 16 } },
      { name: 'Potato Salad',                      macros: { cal: 220, protein: 3,  carbs: 24, fat: 12 } },
      { name: 'Side Salad',                        macros: { cal: 100, protein: 3,  carbs: 10, fat: 5  } },
      { name: 'Cheese Grits',                      macros: { cal: 200, protein: 6,  carbs: 28, fat: 8  } },
      { name: 'Breakfast Potatoes',                macros: { cal: 180, protein: 3,  carbs: 24, fat: 8  } },
      { name: 'Fruit Cup',                         macros: { cal: 70,  protein: 1,  carbs: 18, fat: 0  } },
      { name: 'Thick-Cut Bacon',                   macros: { cal: 120, protein: 8,  carbs: 0,  fat: 10 } },
      { name: 'Pork or Turkey Sausage',            macros: { cal: 160, protein: 10, carbs: 2,  fat: 12 } },
      { name: 'Buttermilk Biscuit',                macros: { cal: 200, protein: 4,  carbs: 28, fat: 8  } },
      { name: 'Egg Any Style',                     macros: { cal: 90,  protein: 6,  carbs: 1,  fat: 7  } },
    ],
  },
  {
    emoji: '🥤', label: 'Shakes',
    items: [
      { name: 'Classic Shake (vanilla/choc/straw)', macros: { cal: 580, protein: 10, carbs: 80, fat: 24 } },
      { name: 'Malt (vanilla/choc/straw)',          macros: { cal: 640, protein: 12, carbs: 86, fat: 26 } },
      { name: 'Nutella Shake',                     macros: { cal: 680, protein: 12, carbs: 82, fat: 34 } },
      { name: 'Bananatella',                       macros: { cal: 700, protein: 12, carbs: 90, fat: 34 } },
      { name: 'Dreamsicle',                        macros: { cal: 580, protein: 8,  carbs: 80, fat: 24 } },
      { name: 'Ginger Finger (Butterfinger)',       macros: { cal: 640, protein: 10, carbs: 86, fat: 28 } },
      { name: 'PB&J',                              macros: { cal: 680, protein: 14, carbs: 84, fat: 32 } },
      { name: 'Maltdown (Whoppers)',               macros: { cal: 620, protein: 10, carbs: 84, fat: 26 } },
      { name: 'Ray Au Lait (Coffee)',              macros: { cal: 560, protein: 10, carbs: 74, fat: 24 } },
    ],
  },
  {
    emoji: '🍨', label: 'Soda Fountain',
    items: [
      { name: 'Banana Split',                      macros: { cal: 750, protein: 10, carbs: 110, fat: 30 } },
      { name: 'Cookie Monster Sundae',             macros: { cal: 780, protein: 10, carbs: 112, fat: 34 } },
      { name: 'Hot Fudge Sundae',                  macros: { cal: 560, protein: 8,  carbs: 80,  fat: 24 } },
      { name: 'Root Beer Float',                   macros: { cal: 380, protein: 4,  carbs: 68,  fat: 10 } },
      { name: 'Coke Float',                        macros: { cal: 360, protein: 4,  carbs: 64,  fat: 10 } },
      { name: 'Ice Cream Soda',                    macros: { cal: 320, protein: 4,  carbs: 58,  fat: 8  } },
      { name: "Brent's Daily Pie",                 macros: { cal: 350, protein: 4,  carbs: 52,  fat: 14 } },
      { name: 'Fried Hand Pie',                    macros: { cal: 380, protein: 4,  carbs: 56,  fat: 16 } },
      { name: 'Ice Cream (per scoop)',             macros: { cal: 160, protein: 2,  carbs: 22,  fat: 7  } },
      { name: 'Fresh-Squeezed Lemonade',           macros: { cal: 150, protein: 0,  carbs: 40,  fat: 0  } },
      { name: 'Arnold Palmer',                     macros: { cal: 100, protein: 0,  carbs: 26,  fat: 0  } },
    ],
  },
]

export const WINGSTOP_MENU: FFCategory[] = [
  {
    emoji: '🍗', label: 'Classic Wings — 6pc',
    items: [
      { name: 'Lemon Pepper 6pc',          macros: { cal: 720,  protein: 60, carbs: 0,  fat: 48 } },
      { name: 'Garlic Parmesan 6pc',       macros: { cal: 720,  protein: 60, carbs: 6,  fat: 48 } },
      { name: 'Hot Honey Rub 6pc',         macros: { cal: 720,  protein: 60, carbs: 12, fat: 48 } },
      { name: 'Mild 6pc',                  macros: { cal: 720,  protein: 60, carbs: 0,  fat: 48 } },
      { name: 'Louisiana Rub 6pc',         macros: { cal: 660,  protein: 60, carbs: 0,  fat: 42 } },
      { name: 'Hawaiian 6pc',              macros: { cal: 600,  protein: 60, carbs: 18, fat: 30 } },
      { name: 'Hickory Smoked BBQ 6pc',    macros: { cal: 600,  protein: 60, carbs: 24, fat: 30 } },
      { name: 'Mango Habanero 6pc',        macros: { cal: 600,  protein: 60, carbs: 24, fat: 30 } },
      { name: 'Spicy Korean Q 6pc',        macros: { cal: 600,  protein: 60, carbs: 18, fat: 30 } },
      { name: 'Atomic 6pc',                macros: { cal: 540,  protein: 60, carbs: 6,  fat: 30 } },
      { name: 'Cajun 6pc',                 macros: { cal: 540,  protein: 60, carbs: 0,  fat: 30 } },
      { name: 'Original Hot 6pc',          macros: { cal: 540,  protein: 60, carbs: 0,  fat: 30 } },
      { name: 'Plain 6pc',                 macros: { cal: 540,  protein: 60, carbs: 0,  fat: 30 } },
    ],
  },
  {
    emoji: '🍗', label: 'Classic Wings — 10pc',
    items: [
      { name: 'Lemon Pepper 10pc',         macros: { cal: 1200, protein: 100, carbs: 0,  fat: 80 } },
      { name: 'Garlic Parmesan 10pc',      macros: { cal: 1200, protein: 100, carbs: 10, fat: 80 } },
      { name: 'Hot Honey Rub 10pc',        macros: { cal: 1200, protein: 100, carbs: 20, fat: 80 } },
      { name: 'Mild 10pc',                 macros: { cal: 1200, protein: 100, carbs: 0,  fat: 80 } },
      { name: 'Louisiana Rub 10pc',        macros: { cal: 1100, protein: 100, carbs: 0,  fat: 70 } },
      { name: 'Hawaiian 10pc',             macros: { cal: 1000, protein: 100, carbs: 30, fat: 50 } },
      { name: 'Hickory Smoked BBQ 10pc',   macros: { cal: 1000, protein: 100, carbs: 40, fat: 50 } },
      { name: 'Mango Habanero 10pc',       macros: { cal: 1000, protein: 100, carbs: 40, fat: 50 } },
      { name: 'Spicy Korean Q 10pc',       macros: { cal: 1000, protein: 100, carbs: 30, fat: 50 } },
      { name: 'Atomic 10pc',               macros: { cal: 900,  protein: 100, carbs: 10, fat: 50 } },
      { name: 'Cajun 10pc',                macros: { cal: 900,  protein: 100, carbs: 0,  fat: 50 } },
      { name: 'Original Hot 10pc',         macros: { cal: 900,  protein: 100, carbs: 0,  fat: 50 } },
      { name: 'Plain 10pc',                macros: { cal: 900,  protein: 100, carbs: 0,  fat: 50 } },
    ],
  },
  {
    emoji: '🍢', label: 'Boneless Wings — 6pc',
    items: [
      { name: 'Garlic Parmesan Boneless 6pc',    macros: { cal: 660,  protein: 24, carbs: 36, fat: 42 } },
      { name: 'Hot Honey Rub Boneless 6pc',      macros: { cal: 660,  protein: 24, carbs: 48, fat: 42 } },
      { name: 'Lemon Pepper Boneless 6pc',       macros: { cal: 660,  protein: 24, carbs: 36, fat: 42 } },
      { name: 'Mild Boneless 6pc',               macros: { cal: 660,  protein: 24, carbs: 36, fat: 42 } },
      { name: 'Louisiana Rub Boneless 6pc',      macros: { cal: 600,  protein: 24, carbs: 36, fat: 36 } },
      { name: 'Hawaiian Boneless 6pc',           macros: { cal: 540,  protein: 24, carbs: 48, fat: 27 } },
      { name: 'Hickory Smoked BBQ Boneless 6pc', macros: { cal: 540,  protein: 30, carbs: 54, fat: 27 } },
      { name: 'Mango Habanero Boneless 6pc',     macros: { cal: 540,  protein: 24, carbs: 54, fat: 27 } },
      { name: 'Spicy Korean Q Boneless 6pc',     macros: { cal: 540,  protein: 30, carbs: 48, fat: 27 } },
      { name: 'Atomic Boneless 6pc',             macros: { cal: 540,  protein: 24, carbs: 42, fat: 27 } },
      { name: 'Cajun Boneless 6pc',              macros: { cal: 480,  protein: 24, carbs: 36, fat: 27 } },
      { name: 'Original Hot Boneless 6pc',       macros: { cal: 480,  protein: 24, carbs: 36, fat: 27 } },
      { name: 'Plain Boneless 6pc',              macros: { cal: 480,  protein: 24, carbs: 36, fat: 27 } },
    ],
  },
  {
    emoji: '🍢', label: 'Boneless Wings — 10pc',
    items: [
      { name: 'Garlic Parmesan Boneless 10pc',    macros: { cal: 1100, protein: 40, carbs: 60, fat: 70 } },
      { name: 'Hot Honey Rub Boneless 10pc',      macros: { cal: 1100, protein: 40, carbs: 80, fat: 70 } },
      { name: 'Lemon Pepper Boneless 10pc',       macros: { cal: 1100, protein: 40, carbs: 60, fat: 70 } },
      { name: 'Mild Boneless 10pc',               macros: { cal: 1100, protein: 40, carbs: 60, fat: 70 } },
      { name: 'Louisiana Rub Boneless 10pc',      macros: { cal: 1000, protein: 40, carbs: 60, fat: 60 } },
      { name: 'Hawaiian Boneless 10pc',           macros: { cal: 900,  protein: 40, carbs: 80, fat: 45 } },
      { name: 'Hickory Smoked BBQ Boneless 10pc', macros: { cal: 900,  protein: 50, carbs: 90, fat: 45 } },
      { name: 'Mango Habanero Boneless 10pc',     macros: { cal: 900,  protein: 40, carbs: 90, fat: 45 } },
      { name: 'Spicy Korean Q Boneless 10pc',     macros: { cal: 900,  protein: 50, carbs: 80, fat: 45 } },
      { name: 'Atomic Boneless 10pc',             macros: { cal: 900,  protein: 40, carbs: 70, fat: 45 } },
      { name: 'Cajun Boneless 10pc',              macros: { cal: 800,  protein: 40, carbs: 60, fat: 45 } },
      { name: 'Original Hot Boneless 10pc',       macros: { cal: 800,  protein: 40, carbs: 60, fat: 45 } },
      { name: 'Plain Boneless 10pc',              macros: { cal: 800,  protein: 40, carbs: 60, fat: 45 } },
    ],
  },
  {
    emoji: '🍳', label: 'Chicken Tenders — 3pc',
    items: [
      { name: 'Garlic Parmesan Tenders 3pc',   macros: { cal: 630,  protein: 30, carbs: 33, fat: 42 } },
      { name: 'Hot Honey Rub Tenders 3pc',     macros: { cal: 660,  protein: 30, carbs: 42, fat: 42 } },
      { name: 'Mild Tenders 3pc',              macros: { cal: 600,  protein: 30, carbs: 30, fat: 42 } },
      { name: 'Lemon Pepper Tenders 3pc',      macros: { cal: 600,  protein: 30, carbs: 30, fat: 39 } },
      { name: 'Louisiana Rub Tenders 3pc',     macros: { cal: 540,  protein: 30, carbs: 30, fat: 36 } },
      { name: 'Hawaiian Tenders 3pc',          macros: { cal: 480,  protein: 30, carbs: 48, fat: 21 } },
      { name: 'Hickory Smoked BBQ Tenders 3pc',macros: { cal: 510,  protein: 30, carbs: 51, fat: 21 } },
      { name: 'Mango Habanero Tenders 3pc',    macros: { cal: 510,  protein: 30, carbs: 51, fat: 21 } },
      { name: 'Spicy Korean Q Tenders 3pc',    macros: { cal: 510,  protein: 30, carbs: 48, fat: 21 } },
      { name: 'Atomic Tenders 3pc',            macros: { cal: 450,  protein: 30, carbs: 36, fat: 21 } },
      { name: 'Cajun Tenders 3pc',             macros: { cal: 450,  protein: 30, carbs: 33, fat: 21 } },
      { name: 'Original Hot Tenders 3pc',      macros: { cal: 420,  protein: 30, carbs: 30, fat: 21 } },
      { name: 'Plain Tenders 3pc',             macros: { cal: 420,  protein: 30, carbs: 30, fat: 21 } },
    ],
  },
  {
    emoji: '🥪', label: 'Chicken Sandwiches',
    items: [
      { name: 'Hot Honey Rub Sandwich',     macros: { cal: 930,  protein: 33, carbs: 81, fat: 51 } },
      { name: 'Mild Sandwich',              macros: { cal: 870,  protein: 32, carbs: 67, fat: 52 } },
      { name: 'Lemon Pepper Sandwich',      macros: { cal: 850,  protein: 32, carbs: 67, fat: 50 } },
      { name: 'Louisiana Rub Sandwich',     macros: { cal: 790,  protein: 32, carbs: 67, fat: 43 } },
      { name: 'Garlic Parmesan Sandwich',   macros: { cal: 890,  protein: 34, carbs: 71, fat: 52 } },
      { name: 'Mango Habanero Sandwich',    macros: { cal: 740,  protein: 32, carbs: 94, fat: 24 } },
      { name: 'Hickory Smoked BBQ Sandwich',macros: { cal: 730,  protein: 34, carbs: 96, fat: 24 } },
      { name: 'Spicy Korean Q Sandwich',    macros: { cal: 720,  protein: 34, carbs: 90, fat: 24 } },
      { name: 'Hawaiian Sandwich',          macros: { cal: 710,  protein: 33, carbs: 90, fat: 24 } },
      { name: 'Atomic Sandwich',            macros: { cal: 650,  protein: 33, carbs: 74, fat: 24 } },
      { name: 'Cajun Sandwich',             macros: { cal: 640,  protein: 33, carbs: 70, fat: 25 } },
      { name: 'Original Hot Sandwich',      macros: { cal: 630,  protein: 33, carbs: 68, fat: 25 } },
      { name: 'Plain Sandwich',             macros: { cal: 610,  protein: 32, carbs: 66, fat: 24 } },
    ],
  },
  {
    emoji: '🍟', label: 'Fries & Sides',
    items: [
      { name: 'Seasoned Fries Regular',         macros: { cal: 500,  protein: 8,  carbs: 69, fat: 21 } },
      { name: 'Seasoned Fries Large',           macros: { cal: 900,  protein: 14, carbs: 126, fat: 37 } },
      { name: 'Cheese Fries Regular',           macros: { cal: 580,  protein: 9,  carbs: 75, fat: 27 } },
      { name: 'Cheese Fries Large',             macros: { cal: 1020, protein: 15, carbs: 134, fat: 47 } },
      { name: 'Buffalo Ranch Fries Regular',    macros: { cal: 610,  protein: 8,  carbs: 71, fat: 32 } },
      { name: 'Buffalo Ranch Fries Large',      macros: { cal: 1070, protein: 15, carbs: 129, fat: 55 } },
      { name: 'Louisiana Voodoo Fries Regular', macros: { cal: 680,  protein: 9,  carbs: 75, fat: 38 } },
      { name: 'Louisiana Voodoo Fries Large',   macros: { cal: 1180, protein: 16, carbs: 133, fat: 64 } },
      { name: 'Fried Corn Regular (5pc)',        macros: { cal: 200,  protein: 6,  carbs: 24, fat: 9  } },
      { name: 'Fried Corn Large (10pc)',         macros: { cal: 400,  protein: 12, carbs: 48, fat: 18 } },
      { name: 'Ranch Dip',                      macros: { cal: 320,  protein: 1,  carbs: 2,  fat: 34 } },
      { name: 'Blue Cheese Dip',                macros: { cal: 330,  protein: 4,  carbs: 4,  fat: 33 } },
      { name: 'Honey Mustard Dip',              macros: { cal: 390,  protein: 0,  carbs: 18, fat: 33 } },
      { name: 'Cheddar Cheese Sauce',           macros: { cal: 120,  protein: 2,  carbs: 8,  fat: 9  } },
      { name: 'Brownie',                        macros: { cal: 430,  protein: 6,  carbs: 49, fat: 24 } },
      { name: 'Celery Sticks',                  macros: { cal: 10,   protein: 1,  carbs: 2,  fat: 0  } },
      { name: 'Carrot Sticks',                  macros: { cal: 25,   protein: 1,  carbs: 7,  fat: 0  } },
    ],
  },
  {
    emoji: '🥤', label: 'Drinks',
    items: [
      { name: 'Coke (20oz)',               macros: { cal: 250,  protein: 0, carbs: 68, fat: 0 } },
      { name: 'Coke (32oz)',               macros: { cal: 400,  protein: 0, carbs: 108, fat: 0 } },
      { name: 'Dr Pepper (20oz)',          macros: { cal: 230,  protein: 0, carbs: 65, fat: 0 } },
      { name: 'Dr Pepper (32oz)',          macros: { cal: 360,  protein: 0, carbs: 104, fat: 0 } },
      { name: 'Sprite (20oz)',             macros: { cal: 240,  protein: 0, carbs: 65, fat: 0 } },
      { name: 'Lemonade (20oz)',           macros: { cal: 240,  protein: 0, carbs: 65, fat: 0 } },
      { name: 'Sweet Tea (20oz)',          macros: { cal: 180,  protein: 0, carbs: 45, fat: 0 } },
      { name: 'Diet Coke / Unsweet Tea',   macros: { cal: 0,    protein: 0, carbs: 0,  fat: 0 } },
    ],
  },
]
